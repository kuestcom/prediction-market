...
- [Data API](/data-api/markets/get-top-holders) — The `negRisk` and `negRiskAugmented` flags are present on event payloads.
- [Subgraphs](/subgraph/overview) — Query the metadata entity for `enableNegRisk` to show conversion controls.
