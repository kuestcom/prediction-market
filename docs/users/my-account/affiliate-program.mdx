...
<Note>
  Need Help? Reach out on <a href={ENV.NEXT_PUBLIC_DISCORD_LINK} rel="noopener noreferrer" target="_blank">Discord</a> and the team will walk you through the affiliate tools.
</Note>
)}
