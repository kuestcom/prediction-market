...
_openapi:
  method: POST
---
Submit a new order to the {process.env.NEXT_PUBLIC_SITE_NAME} central limit order book. Orders are accepted for matching immediately; validation happens synchronously and the response tells you whether the request was persisted.
